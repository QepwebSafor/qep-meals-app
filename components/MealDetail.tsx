    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-8 px-2">
        ...
        <table className="table-auto text-black ">
                    <thead>
                      <tr>
                        <th>  <h1 className="text-xl font-bold bg-yellow-300 p-3 w-fit mx-auto ">Ingredients</h1></th>
                        <th>  <h1 className="text-xl font-bold bg-yellow-300 p-3 w-fit mx-auto ">Meausure</h1></th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
